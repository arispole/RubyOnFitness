class BookedPrivateLessonsController < ApplicationController
	...
	def book
		...
		@bookedprivatelesson = authorize current_user.booked_private_lessons.new
	...
	def destroy
		id = params[:id]
		@bookedprivatelesson = authorize BookedPrivateLesson.find(id)
	...
	def showbooked
		@bookedprivatelessons = authorize current_user.booked_private_lessons
	end
